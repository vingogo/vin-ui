...
export default createDemo({
  ...
  setup() {
    ...
    const events = {
      change(...args: any) {
        console.log('change', ...args, demo1.value);
      },
      pathChange(...args: any) {
