<template>
  <demo-page-layout title="滚动加载">
    <vin-cell-group :title="translate('basic')">
      <vin-cell>
        <view class="infiniteUl" id="scroll">
          <vin-infiniteloading
            container-id="scroll"
            :use-window="false"
            :has-more="hasMore"
            @load-more="loadMore"
          >
            <view class="infiniteLi" v-for="(item, index) in defultList" :key="index">
              {{ item }}
            </view>
          </vin-infiniteloading>
        </view>
    ...
    <vin-cell-group :title="translate('pullRefresh')">
      <vin-cell>
    ...
    <vin-cell-group :title="translate('customTxt')">
      <vin-cell>
        <view class="infiniteUl" id="customScroll">
          <vin-infiniteloading
            load-text="loading"
            :load-more-text="translate('none')"
            container-id="customScroll"
            :use-window="false"
            :has-more="customHasMore"
            @load-more="customLoadMore"
          >
            <view class="infiniteLi" v-for="(item, index) in customList" :key="index">
              {{ item }}
            </view>
          </vin-infiniteloading>
        </view>
