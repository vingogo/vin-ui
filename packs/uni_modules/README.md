...
> 推荐使用 npm 的方式安装，[uni-app 插件市场](https://ext.dcloud.net.cn/plugin?id=11187)更新可能会相对落后，关注 [Github](https://github.com/vingogo/vin-ui) 可以保持最新版本信息
...
- [版本更新记录](https://github.com/vingogo/vin-ui/releases)
